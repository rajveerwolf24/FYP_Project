...
<head>
  ...
  <title>Ace Abstract Admin Login</title>
  ...
  <div class="login-logo">
    <div class="center">
        <h1>
                ...
                <span class="red">Ace Abstract Management System</span>
        </h1>
                <h4 class="blue" id="id-company-text">&copy; Ace Abstract</h4>
    </div>
  </div>
   ...
   <hr>
    ...
    <hr>
        ...
        <div align="center" style="color: black;">
            © 2022 Ace Abstract Web Design. All rights reserved v2.0 <br>
            Design by Rajveer 
        </div>
